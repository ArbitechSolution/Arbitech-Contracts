...
////////////////////////// Auction Variables    ///////////////////////////////////
    ...
    function preMaleMint() public preMinter(1) {
      ...
      preMaleCount = preMaleCount.add(1);
    ...
    function preFemaleMint() public preMinter(2) {
      ...
      preFemaleCount = preFemaleCount.add(1);
    ...
    function publicMaleMint(uint256 _count) public payable publicMinter(_count) {
      require(collection[1].availableTokens >= 1, "Total supply reached its maximum!!");
    ...
    function publicFemaleMint(uint256 _count) public payable publicMinter(_count) {
      require(collection[2].availableTokens >= 1, "Total supply reached its maximum!!");
      require(msg.value >= minPublicMintPrice.mul(_count), "Less Amount!!");
    ...
    {
        require(isAuctionStarted, "AUCTION is not started yet!");
        uint256 totalPrice;
        uint256 increament;
        uint256 Price;
    ...
    {
        require(isAuctionStarted, "AUCTION is not started yet!");
        require(collection[3].availableTokens >= 1, "Supply reached its maximum!!");
    ...
    function setPrefixURI(string memory _prefix1, string memory _prefix2, string memory _prefix3)
    external onlyOwner{
        prefix1 = _prefix1;
        prefix2 = _prefix2;
        prefix3 = _prefix3;
